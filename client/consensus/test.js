...
stateValidators.setCandidate(salem_address)
...
// (async () =>{
  ...
  george_voter.addStake(2, salem_address);
  peter_voter.addStake(3, sofiya_address);
  peter_voter.addStake(5, vitya_address);
