...
describe('TxMemPool', () => {
	...
	it('should create a correct signature', () => {
		...
		let private_key = 0xC2D7CF95645D33006175B78989035C7c9061d3F9
		...
		if (utxoN.new_owner instanceof Buffer)
			...
			utxoN.new_owner = ethUtil.addHexPrefix(utxoN.new_owner.toString('hex')).toLowerCase();

		expect(txRlpEncoded).to.be.an.instanceof(Buffer);

		let keyFroEcsign = Buffer.from(private_key.toString(16))
